...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#fixtureslists").dialog({
                    autoOpen: true,
                    position:[500,220],
                    title: 'Fixtures List Report',
                    height: 440,
                    width: 700,
                    modal: false,
                    buttons: {
                        PDF: function() {
                            doFixturesListsReport();
                        },
                        Close: function() {
                            $('#fixtureslists').dialog('close');
    ...
    <body>
        <table width="100%">
            ...
            <tr>
                <td>
                    <div style="font-size:65%; height:235px; top:5px; left:10px" id="fixtureslists">
						<table>
							<tr>
