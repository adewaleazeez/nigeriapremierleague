<?php
	...
	mysql_select_db("nigerialeague");
	//include("data.php"); 
	
	$currentuser = $_COOKIE['currentuser'];
	if($currentuser == null || $currentuser == "") $currentuser = 'AbuNPL';
	if($leaguenames == null || $leaguenames == "") $leaguenames = 'Premiership';
	if($seasons == null || $seasons == "") $seasons = '2011/2012';
